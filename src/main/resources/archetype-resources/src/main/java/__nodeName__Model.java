...
/**
 * {@link NodeModel} for the "${nodeName}" Node.
 */
public class ${nodeName}Model extends NodeModel {
  ...
  private final SettingsModelIntegerBounded m_count = new SettingsModelIntegerBounded(${nodeName}Model.CFGKEY_COUNT, ${nodeName}Model.DEFAULT_COUNT, Integer.MIN_VALUE, Integer.MAX_VALUE);
